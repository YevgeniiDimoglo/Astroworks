...
void OverlayScene::initialize(GLFWwindow* window)
{
	...
	std::vector<std::string> LevelCompute = {
	"7d",
	"7h",
	"7h",
	"7h"
	...
	std::shared_ptr<Widget> buttonLevelCompute = std::make_shared<Button>(LevelCompute);
	buttonLevelCompute->setImageValues(0.9f, 0.35f, 0.f, 0.05f, 0.085f, glm::radians(0.f), 1.f, 1.f, 1.f, 1.f);

	std::vector<std::shared_ptr<Widget>> sceneButtons = { buttonLevelScene, buttonLevelPBR, buttonLevelOIT, buttonLevelTextures, buttonLevelMisc, buttonLevelBig, buttonLevelCompute };
